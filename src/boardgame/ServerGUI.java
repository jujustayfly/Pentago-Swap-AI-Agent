...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    protected static final String[] PLAYER_CLASSES = { "pentago_swap.RandomPentagoPlayer", "student_player.StudentPlayer","agent1.Agent1","greedyagent.GreedyAgent","minimax.Minimax" };
